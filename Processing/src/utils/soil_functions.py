...
class SoilClean:
    ...
    def modify_columns(self, data:spark.createDataFrame) ->spark.createDataFrame:
        ...
        df = (
            ...
            .withColumnRenamed("Acidez (Al+H) KCL cmol(+)/kg", "acidez_al_h_kcl_cmol_kg")
            .withColumnRenamed("Aluminio (Al) intercambiable cmol(+)/kg", "aluminio_al_intercambiable_cmol_kg")
    ...
    def drop_columns(self, data:spark.createDataFrame) ->spark.createDataFrame:
        ...
        df = (
            ...
            .drop(F.col("acidez_al_h_kcl_cmol_kg"))
            .drop(F.col("aluminio_al_intercambiable_cmol_kg"))
