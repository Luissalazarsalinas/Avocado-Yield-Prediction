...
def clean_temp_data():
    # path of files
    path = "hdfs://localhost:9000/raw/Colombia/crops/env/" + str(date.today()) + "/Datos_Hidrometeorol_gicos_Crudos_-_Red_de_Estaciones_IDEAM___Temperatura.csv"
    path1 = "hdfs://localhost:9000/raw/Colombia/crops/env/" + str(date.today()) + "/Datos_Hidrometeorol_gicos_Crudos_-_Red_de_Estaciones_IDEAM___Temperatura (1).csv"
    path2 = "hdfs://localhost:9000/raw/Colombia/crops/env/" + str(date.today()) + "/Datos_Hidrometeorol_gicos_Crudos_-_Red_de_Estaciones_IDEAM___Temperatura (2).csv"
    ...
    path_out = "hdfs://localhost:9000/clean/Colombia/crops/" + str(date.today()) + "/temp_clean.parquet"
