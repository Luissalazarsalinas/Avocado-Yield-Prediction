...
def clean_avacado_data():
    ...
    path = "hdfs://localhost:9000/raw/Colombia/crops/yield/" + str(date.today()) + "/Evaluaciones_Agropecuarias_Municipales_EVA.csv"
    ...
    path_out = "hdfs://localhost:9000/clean/Colombia/crops/" + str(date.today()) + "/avocado_clean.parquet"
