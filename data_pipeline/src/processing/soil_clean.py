...
def clean_soil_data():
    ...
    path = "hdfs://localhost:9000/raw/Colombia/crops/soil/" + str(date.today()) + "/Resultados_de_An_lisis_de_Laboratorio_Suelos_en_Colombia.csv"
    df = (
        spark.read
        .option("header", "true")
        .option("sep", ",")
    ...
    path_out = "hdfs://localhost:9000/clean/Colombia/crops/" + str(date.today()) + "/soil_clean.parquet"
